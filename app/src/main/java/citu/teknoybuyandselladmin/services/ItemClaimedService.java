 ...
 */
public class ItemClaimedService extends ConnectionService {

    public static final String TAG = "ItemClaimedSvc";
    public static final String ACTION = ItemClaimedService.class.getCanonicalName();

    public ItemClaimedService() {
        super(TAG);
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.e(TAG, "setting item claimed. . .");
        ...
        try{
            ...
            Call<ResponseStatus> call = service.setItemClaimed(requestId, itemId);
            ...
            if(response.code() == HttpURLConnection.HTTP_OK){
                ...
                if(statusCode == HttpURLConnection.HTTP_OK){
                    ...
                    notifySuccess(ACTION, "item_claimed");
                }
                else{
